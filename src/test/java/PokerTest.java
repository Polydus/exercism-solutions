...
public class PokerTest {
    ...
    @Test
    public void twoEqualSinglePairs() {
        String pairOf2 = "4S 4H 6S 2D JH";
        String pairOf2BetterKicker = "4S 4H 6S 3D JH"; //this one is better
        assertEquals(Collections.singletonList(pairOf2BetterKicker),
                new Poker(Arrays.asList(pairOf2, pairOf2BetterKicker)).getBestHands());
    }
